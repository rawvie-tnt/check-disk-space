...
declare function checkZfsPool(dependencies?: Dependencies): Promise<number | null>;

export { Dependencies, DiskSpace, InvalidPathError, NoMatchError, checkZfsPool, checkDiskSpace as default, getFirstExistingParentPath };
